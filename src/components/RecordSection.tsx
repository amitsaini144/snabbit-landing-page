...
export default function RecordSection() {
    return (
        <div className="w-full px-6 md:px-10 pt-20 pb-32 bg-[#F70F79] max-w-[1423px] mx-auto">
            <div className="flex flex-col justify-between lg:px-24 gap-20 md:gap-24">
                ...
                <div className="flex flex-col md:flex-row gap-y-8 md:justify-around">
                    ...
                    <div className="flex flex-col items-center">
                        <h2 className="text-[70px] lg:text-[80px] font-bold tracking-tighter leading-tight text-white">12 k+</h2>
                        <p className="text-xl lg:text-2xl w-[80%] text-center text-white/60">Hours of Service Provided</p>
                    </div>

                    <div className="flex flex-col items-center">
                        <h2 className="text-[70px] lg:text-[80px] font-bold tracking-tighter leading-tight text-white">4.5
